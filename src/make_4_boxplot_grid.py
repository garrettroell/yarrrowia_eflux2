...
def make_4_boxplot_grid(df, substrate):
    ...
    for _, row in df.iterrows():
        ...
        # generate mfa column names based on the substrate
        ...
        eflux2_box_lb_col = f'{substrate}_1_eflux2_LB'
        eflux2_box_ub_col = f'{substrate}_1_eflux2_UB'
        eflux2_whisker_lb_col = f'{substrate}_pfba_LB'
        eflux2_whisker_ub_col = f'{substrate}_pfba_UB'
        ...
        eflux2_box_lb_col = f'{substrate}_2_eflux2_LB'
        eflux2_box_ub_col = f'{substrate}_2_eflux2_UB'
        eflux2_whisker_lb_col = f'{substrate}_pfba_LB'
        eflux2_whisker_ub_col = f'{substrate}_pfba_UB'
        ...
        eflux2_box_lb_col = f'{substrate}_3_eflux2_LB'
        eflux2_box_ub_col = f'{substrate}_3_eflux2_UB'
        eflux2_whisker_lb_col = f'{substrate}_pfba_LB'
        eflux2_whisker_ub_col = f'{substrate}_pfba_UB'
        ...
        eflux2_1_bounds_have_nan = any(pd.isna(list(eflux2_1_stats.values())))
        eflux2_2_bounds_have_nan = any(pd.isna(list(eflux2_2_stats.values())))
        eflux2_3_bounds_have_nan = any(pd.isna(list(eflux2_3_stats.values())))
        
        if mfa_bounds_have_nan or eflux2_1_bounds_have_nan or eflux2_2_bounds_have_nan or eflux2_3_bounds_have_nan:
            continue
        else:
...
def make_boxplot(ax, mfa_stats, eflux2_1_stats, eflux2_2_stats, eflux2_3_stats, show_y_label, title=''):
    ...
    for index, box_data in enumerate([mfa_stats, eflux2_1_stats, eflux2_2_stats, eflux2_3_stats]):
        ax.bxp(
            [{
            'med': box_data['median'],
            'q1': box_data['q1'],
    ...
    ax.set_xticklabels(['13C-MFA', 'EF2 1', 'EF2 2', 'EF2 3'])
    ax.set_title(title)