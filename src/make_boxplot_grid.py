...
def make_5_boxplot_grid(df, substrate, box_biomass_percent, whisker_biomass_percent):
    ...
    for _, row in df.iterrows():
        ...
        pfba_box_lb_col = f'{substrate}_pfba_{box_biomass_percent}_LB'
        pfba_box_ub_col = f'{substrate}_pfba_{box_biomass_percent}_UB'
        pfba_whisker_lb_col = f'{substrate}_pfba_{whisker_biomass_percent}_LB'
        pfba_whisker_ub_col = f'{substrate}_pfba_{whisker_biomass_percent}_UB'
        ...
        eflux2_box_lb_col = f'{substrate}_1_eflux2_{box_biomass_percent}_LB'
        eflux2_box_ub_col = f'{substrate}_1_eflux2_{box_biomass_percent}_UB'
        eflux2_whisker_lb_col = f'{substrate}_1_eflux2_{whisker_biomass_percent}_LB'
        eflux2_whisker_ub_col = f'{substrate}_1_eflux2_{whisker_biomass_percent}_UB'
        ...
        eflux2_box_lb_col = f'{substrate}_2_eflux2_{box_biomass_percent}_LB'
        eflux2_box_ub_col = f'{substrate}_2_eflux2_{box_biomass_percent}_UB'
        eflux2_whisker_lb_col = f'{substrate}_2_eflux2_{whisker_biomass_percent}_LB'
        eflux2_whisker_ub_col = f'{substrate}_2_eflux2_{whisker_biomass_percent}_UB'
        ...
        eflux2_box_lb_col = f'{substrate}_3_eflux2_{box_biomass_percent}_LB'
        eflux2_box_ub_col = f'{substrate}_3_eflux2_{box_biomass_percent}_UB'
        eflux2_whisker_lb_col = f'{substrate}_3_eflux2_{whisker_biomass_percent}_LB'
        eflux2_whisker_ub_col = f'{substrate}_3_eflux2_{whisker_biomass_percent}_UB'
...
def make_boxplot(ax, mfa_stats, pfba_stats, eflux2_1_stats, eflux2_2_stats, eflux2_3_stats, show_y_label, title=''):
    ...
    if show_y_label:
        ax.set_ylabel('Flux (mmol/g DCW/ hr)')
